...
function Hero() {
    ...
    return (
        <section className="bg-white py-6 md:py-12 min-h-[70vh] flex items-center">
            <div className="max-w-5xl mx-auto px-4 w-full">
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    
                    {/* COLUMNA IZQUIERDA: Bloque de Evento Puro (Abajo en celu) */}
                    <div className="flex flex-col justify-center items-start gap-6 order-last md:order-first w-full">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 justify-center md:justify-start items-center w-full max-w-xl mx-auto md:mx-0 pt-1">
                    ...
                    {/* COLUMNA DERECHA: Reloj + Afiche Oficial (Arriba en celu) */}
                    <div className="flex flex-col gap-3 bg-gray-50 rounded-3xl p-3 md:p-4 justify-center order-first md:order-last border border-gray-100 shadow-inner w-full">
                        
                        {/* EL AFICHE OFICIAL (En celu abajo del reloj, en PC arriba) */}
                        ...
                        {/* EL RELOJ DIGITAL COMPACTO (En celu arriba del afiche, en PC abajo) */}
                                ...
                                <>
                                    ...
                                    <div className="flex justify-center items-center gap-1.5">
                                        <div className="bg-[#111827] text-white rounded-xl p-2 min-w-[50px] md:min-w-[55px] text-center shadow-md flex flex-col items-center">
                                            <span className="text-base md:text-xl font-black text-[#E65C23] leading-tight">{tiempoRestante.dias}</span>
                                            <span className="text-[8px] font-bold uppercase text-gray-400 tracking-wide">Días</span>
                                        </div>
                                        <div className="bg-[#111827] text-white rounded-xl p-2 min-w-[50px] md:min-w-[55px] text-center shadow-md flex flex-col items-center">
                                            <span className="text-base md:text-xl font-black text-white leading-tight">{tiempoRestante.horas.toString().padStart(2, '0')}</span>
                                            <span className="text-[8px] font-bold uppercase text-gray-400 tracking-wide">Hrs</span>
                                        </div>
                                        <div className="bg-[#111827] text-white rounded-xl p-2 min-w-[50px] md:min-w-[55px] text-center shadow-md flex flex-col items-center">
                                            <span className="text-base md:text-xl font-black text-white leading-tight">{tiempoRestante.minutos.toString().padStart(2, '0')}</span>
                                            <span className="text-[8px] font-bold uppercase text-gray-400 tracking-wide">Min</span>
                                        </div>
                                        <div className="bg-[#111827] text-white rounded-xl p-2 min-w-[50px] md:min-w-[55px] text-center shadow-md flex flex-col items-center">
                                            <span className="text-base md:text-xl font-black text-[#E65C23] leading-tight animate-pulse">{tiempoRestante.segundos.toString().padStart(2, '0')}</span>
